import sys
sys.path.append('/Users/guido/Documents/github/mexusdt/mexc-api-demo/python')
import requests
import hmac
import hashlib
...
class mexc_trade(TOOL):
    ...
    def __init__(self, api_key, api_secret):
        """
        Inicializa la clase de wallet con claves API específicas.
        """
        self.api = '/api/v3'
        self.hosts = 'https://api.mexc.com'  # Esto puede seguir en config si es constante
        self.mexc_key = api_key  # Usa la clave API dinámica
        self.mexc_secret = api_secret  # Usa el secreto API dinámico
